...
RESULT_PATH = os.path.join(project_root, "results", "svm_report.txt")
...
# Using LinearSVC which is good for text classification. Added random_state for reproducibility.
